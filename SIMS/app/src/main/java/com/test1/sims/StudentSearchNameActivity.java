...
public class StudentSearchNameActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nameText = (EditText) findViewById(R.id.et_searchName);
    ...
    public void onClick(View v) {
        if (v == button) {
            ...
            cursor = dao.findStudentName(name);
            if (!cursor.moveToFirst()) {
                Toast.makeText(this, "没有所查姓名信息！", Toast.LENGTH_SHORT).show();
            } else
