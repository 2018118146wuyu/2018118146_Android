...
public class StudentSearchSexActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.search_sex);
        sexText = (EditText) findViewById(R.id.et_searchSex);
    ...
    public void onClick(View v) {
        if (v == button) {
            ...
            cursor = dao.findStudentSex(sex);
            if (!cursor.moveToFirst()) {
                Toast.makeText(this, "没有所查性别信息！", Toast.LENGTH_SHORT).show();
            } else
