...
public class StudentSearchSnoActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.search_sno);
        snoText = (EditText) findViewById(R.id.et_searchSno);
    ...
    public void onClick(View v) {
        if (v == button) {
            ...
            snoText.setVisibility(View.GONE);
            layout.setVisibility(View.VISIBLE);
            String sno = snoText.getText().toString();
            cursor = dao.findStudentSno(sno);
